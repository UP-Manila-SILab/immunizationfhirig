...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://doh.gov.ph/fhir/ph-core/StructureDefinition/indigenous-people']) &gt;= 1">extension with URL = 'http://doh.gov.ph/fhir/ph-core/StructureDefinition/indigenous-people': minimum cardinality of 'extension' is 1</sch:assert>
